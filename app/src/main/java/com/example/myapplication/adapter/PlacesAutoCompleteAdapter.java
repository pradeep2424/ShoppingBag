...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        ...
        // and once again when the user makes a selection (for dronam when calling fetchPlace()).
...
//                .setTypeFilter(TypeFilter.ADDRESS)
                ...
                .setCountry("IN")   //to set country only for e.g australia
//                .setTypeFilter(TypeFilter.ADDRESS)
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View convertView = layoutInflater.inflate(R.layout.item_place_recycler_layout, viewGroup, false);
